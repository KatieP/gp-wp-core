...
?>
	...
	<!--//TABLE OF AD OPTIONS--//-->
    <div id="ad-info-preamble">
       	<p>Hi <?php echo $name; ?>! Greenpages offers an extremely effective kind of online advertising: You get to create your own editorials!</p>
        <p>To get started, first choose an advertiser plan.</p>
    </div>
	...
	<div id="ad-booking-info" class="hidden">
		...
		<div id="ad-info" >
			...
			cost-per-click model. No click, no payment! You can upgrade, downgrade or pause your advertiser plan at any time.</p>
   			<p>
   			    <a href="http://www.thegreenpages.com.au/wp-content/uploads/2012/04/circle2-wide.jpg?39a4ff">
   				    <img class="alignleft size-full wp-image-15017" title="green pages advertising" 
   			        	 ...
   			        	 alt="green pages advertising" width="600" height="350" />
	   			</a>
   			</p>
			<p>How it works</p>
			<p>Step 1. You chose a plan. You will never be billed more than the plan you choose.</p>
	   		...
	   		<p>Your editorial post will be promoted on the www.greenpag.es site and appear on the homepage feed until you reach your 
   			weekly maximum expenditure. Once your budget has been reached, your editorial posts will be paused from view. Your posts 
   			will become visible again when the next week's billing cycle commences.</p>
	  		<p>The more frequently you post, the more people will view your product editorial. If you want more coverage, keep the 
  			posts fresh and coming!</p>
  			<p>We've got maps too! All product editorials have an icon on the maps</p>		
	    	<p><a href="<?php echo $site_url;?>/about/media-kit/">Learn more about who reads greenpag.es</a></p>
	    	...
	    	This subscription allows you to create sponsored editorials in our 
    		<a href="<?php echo $site_url;?>/eco-friendly-products/" target="_blank">Products section</a> as often as you desire! You'll be 
    		able to check your clicks from your member profile.</p>	
			<div>
				<iframe src="http://player.vimeo.com/video/41352429" width="530" height="300" frameborder="0" 
				        webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
			</div>
			<p>Your post will be promoted to our 20,000 members, to our Facebook page, Twitter and will remain 
			on the GP homepage for approximately one day. Each product post includes two images, 500 words and 
			a 'Buy it!' or 'Inquire Now!' button.
			...
			<p><strong>1. Google Adwords</strong> require you to bid higher and higher to increase your click through rate. 
			Only a small amount of clicks each 	week will be available to you at a low price for less that $2.00 per click. 
			Some Google Ads are as high as $20 per click in compeditive markets. <em>The GP difference: We offer a very 
			affordable flat rate of $1.70 - $1.90 per click. </em></p>
			<p><strong>2. Facebook</strong> requires a minimum spend of $10 / day which amounts to about $300 / month -
			quite steep for many small businesses. Facebook also require about a $2 &#8211; $3 per click spend. 
			<em>The GP difference: On Green Pages, your minimum spend is $12 per week (1 tenth of Facebook!). 
			Clicks on Green Pages are also lower cost than on Facebook.</em></p>
			<p><strong>3. Newspaper sites such as New York Times, Sydney Morning Herald or Huffington Post</strong> 
			charge a $70 CPM (one thousand page impressions) for display ads. Click through rates for these kind of 
			banner or display ads are dropping dramatically and are on 
			<a href="http://en.wikipedia.org/wiki/Click-through_rate">average only 0.2% - 0.4%</a> 
			<em>The GP difference: We only offer editorial advertisements which have 10% - 20% click through rate 
			and you only pay for the clicks you receive.</em></p>
			<p><strong>4. Greenpages</strong> has a loyal following of over 20,000 members and between 1,000 and 5,000 
			visitors every day. Green Pages is well known in the environmental community as a place to find environmental 
			products and services. We work exclusively in the core community of environmental professionals.<em>The GP 
			difference: Your advertising hits the spot. There is no other membership available that has such direct access 
			to the world's leading green, environmental and sustainability professionals.</em></p>
			<p><strong>5. We provide an easy to use DIY advertiser centre.</strong> You can set up and serve your own ads, 
			upgrade and downgrade at any time.</p>
			<p><strong>6. Yelp</strong> charge a flat fee which is un-transparent and works out to possibly $150 &#8211; 
			$200 CPM. This is around 10 times the industry average CPM rate. They don&#8217;t even show you conversion rates 
			from impressions to clicks! They also require a 6 month commitment. 
			<a href="http://www.raymondfong.net/misc/a-candid-yelp-advertising-review-is-yelp-ripping-people-off/"  
			   onclick="javascript:_gaq.push(['_trackPageview','/yoast-ga/14971/2/outbound-article/']);">Read more</a> 
			<em>The GP difference: We show your clicks and impressions transparently on your member profile. There is no 
			time commitment and you can cancel any time. We work hard to make sure are advertising rates are less that 
			the industry standard.</em></p>
			<p><strong>7. Green Pages</strong> offers an affordable flat rate per click at $1.70 - $1.90 </p>
			<p><strong>8. Green Pages</strong> uses trackable links which mean our links to your site will help your SEO. 
			<em>The GP difference: Most other sites prevent trackable outbound links. On Green Pages, we do allow links to 
			be trackable by Google, that means your link on Green Pages will help your site&#8217;s SEO, meaning it will 
			help you get higher up on Google&#8217;s search results. </em> </p>
			<p><strong>9. We offer</strong> a personalised service and will work with each client individually to ensure 
			you get a good result for your subscription. Your weekly subscription means the world to us. If you ever feel 
			you are not getting a result, let us know and we&#8217;ll attend to it immediately to supplement your advertising. 
			<em>The GP difference: You will always have a &#8216;real human&#8217; to call or email any time about any issue 
			at all. We are prepared to add any supplementary promotion you need if an ad is not working well.</em></p>
			<p><strong>10. Your money</strong> supports our unique content model of distributing material direct from 
			NGO&#8217;s to a wider audience. Many NGOs rely on Green Pages is their greatest means of letting people know 
			about the important problems they are solving. <em>The GP difference: Your money is going to support Green Pages, 
			an independent technology company that provides the world&#8217;s only aggregate of all NGO news. We bring together 
			the news, campaigns and projects that are saving the planet and put them in touch with thousands of people every day. 
			The more advertisers we have, the better equipped we are to improve and built this service.</em></p>
			<div id="my-advertise">
				<div id="advertorial">
				    <span>
				        <a href="#">
