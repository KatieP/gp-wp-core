...
<!--//INITIAL PAGE INFORMATION-------------------------------------------------------------------------------//-->
	...
	<div style="float: right; margin-top: 20px;"><iframe src="http://player.vimeo.com/video/41346738" frameborder="0" width="380" height="218"></iframe></div>
	...
	<div id="my-advertise">
		<div id="listing"><span><a href="http://www.thegreenpages.com.au/advertise-with-us/list-your-business/">
			<input type="button" value="Subscription $39/m" /></a></span></div>
		</div>
		<div class="clear"></div>
		...
		<div style="float: right; margin-top: 20px;"><iframe src="http://player.vimeo.com/video/41352429" width="380" height="218" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
		...
		<div id="my-advertise">
		<div id="advertorial"><span><a href="http://www.thegreenpages.com.au/forms/create-product-post/">
		<input type="button" value="Post a Product $89" /></a></span></div>
	</div>
	<div class="clear"></div>
	...
	<div style="float: right; margin-top: 20px;"><iframe src="http://player.vimeo.com/video/41414230" width="380" height="218" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
	...
	<div id="my-advertise">
		<div id="listing"><span><a href="http://www.thegreenpages.com.au/advertise-with-us/">
			<input type="button" value="Exclusive Email $3500" /></a></span>
		</div>
	</div>
