...
<div class="wrap">
    ...
    <form name="gp_sitemaps_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
    	<?php
    	...
    	<?php
    	if ( is_array( $sitemaptypes ) && is_array( $newposttypes ) ) {
    		echo '<tr><td></td>';
    		foreach ( $newposttypes as $posttypevalue ) {
    			if ($posttypevalue['enabled'] == true) {
    	...
    	<h4>Add this to your <i>.htaccess</i> file <u>before</u> your Wordpress rules.</h4>
   		<?php
