...
<?php
	...
	function wppb_register_profile_builder(){
?>
		...
		<?php 
			...
			if($serial_number_availability == 'found')
			...
			elseif ($serial_number_availability == 'notFound')
			...
			elseif ($serial_number_availability == 'serverDown')
