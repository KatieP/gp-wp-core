...
function wppb_input_handler($page, $item_title, $id, $item_desc, $item_required, $item_id, $item_type, $currentUser, $filterArray, $extraFieldsErrorHolder, $postData, $item_options, $error, $fieldName){
	...
	if ($page == 'back_end'){
		$filterArray['inputCustomField'] = '
			...
			$filterArray['inputCustomField'] = apply_filters('wppb_'.$page.'_input_custom_field_'.$id, $filterArray['inputCustomField'], $item_title, $item_id, $id, $item_type, $inputValue, trim($item_options), $item_desc);		
	}else{
		$errorVar = '';
		$errorMark = '';
		...
		$filterArray['inputCustomField'] = apply_filters('wppb_'.$page.'_input_custom_field_'.$id, $filterArray['inputCustomField'], $item_title, $item_id, $item_type, $id, $inputValue, $item_options, $item_desc, $item_required, $errorMark, $errorVar);		
	}
...
function wppb_hidden_input_handler($page, $item_title, $id, $item_desc, $item_required, $item_id, $item_type, $currentUser, $filterArray, $extraFieldsErrorHolder, $postData, $item_options, $error, $fieldName){
	...
	if ($page == 'back_end'){
		...
		if (!current_user_can( 'manage_options' ))
			$filterArray['hiddenInputCustomField'] .= '-->';
		$filterArray['hiddenInputCustomField'] = apply_filters('wppb_'.$page.'_hidden_input_custom_field_'.$id, $filterArray['hiddenInputCustomField'], $item_title, $item_id, $item_type, $id, $item_options, $item_desc);		
	}else{
		$filterArray['hiddenInputCustomField'] = '
			<!-- form-input'.$id.$errorVar.'"-->
				...
				<span class="wppb-description-delimiter"><!--'.$item_desc.'--></span>					
			<!-- .form-input'.$id.' -->';
		$filterArray['hiddenInputCustomField'] = apply_filters('wppb_'.$page.'_hidden_input_custom_field_'.$id, $filterArray['hiddenInputCustomField'], $item_title, $item_id, $item_type, $id, $item_options, $item_desc, $errorVar);		
	}
...
function wppb_radio_handler($page, $item_title, $id, $item_desc, $item_required, $item_id, $item_type, $currentUser, $filterArray, $extraFieldsErrorHolder, $postData, $item_options, $error, $fieldName){
	...
	if ($page == 'back_end'){
		...
		$filterArray['radioCustomField'] = apply_filters('wppb_'.$page.'_radio_custom_field_'.$id, $filterArray['radioCustomField'], $userData, $radioValue, $item_id, $id, $item_desc);		
	}else{
		...
		$filterArray['radioCustomField'] = '
			...
			$filterArray['radioCustomField'] = apply_filters('wppb_'.$page.'_radio_custom_field_'.$id, $filterArray['radioCustomField'], $userData, $radioValue, $item_id, $id, $item_desc, $item_required, $_POST[$item_type.$id], $errorMark, $errorVar);
...
function wppb_country_select_handler($page, $item_title, $id, $item_desc, $item_required, $item_id, $item_type, $currentUser, $filterArray, $extraFieldsErrorHolder, $postData, $item_options, $error, $fieldName){
	...
	if ($page == 'back_end'){
		...
		$filterArray['countrySelectCustomField'] = apply_filters('wppb_'.$page.'_country_select_custom_field_'.$id, $filterArray['countrySelectCustomField'], $userData, $item_title, $item_id, $id, $item_desc, $item_required, $countryArray, $errorMark, $errorVar, $error, $_POST[$item_type.$id]);		
	}else{
...
function wppb_timezone_select_handler($page, $item_title, $id, $item_desc, $item_required, $item_id, $item_type, $currentUser, $filterArray, $extraFieldsErrorHolder, $postData, $item_options, $error, $fieldName){
	...
	if ($page == 'back_end'){
		...
		$filterArray['timezoneSelectCustomField'] = apply_filters('wppb_'.$page.'_timezone_select_custom_field_'.$id, $filterArray['timezoneSelectCustomField'], $userData, $item_title, $item_id, $id, $item_desc);		
	}else{
		...
		$filterArray['timezoneSelectCustomField'] = apply_filters('wppb_'.$page.'_timezone_select_custom_field_'.$id, $filterArray['timezoneSelectCustomField'], $userData, $item_title, $item_id, $id, $item_desc, $item_required, $error, $_POST[$item_type.$id], $timezoneArray, $errorMark, $errorVar);
...
function wppb_datepicker_handler($page, $item_title, $id, $item_desc, $item_required, $item_id, $item_type, $currentUser, $filterArray, $extraFieldsErrorHolder, $postData, $item_options, $error, $fieldName){
	...
	if ($page == 'back_end'){
		$filterArray['datepickerCustomField'] = '
			<table class="form-table">
				<tr>
					<th><label for="'.$item_title.'">'.$item_title.'</label></th>
					<td>
						<input size="45" name="'.$item_type.$id.'" type="text" class="wppb_datepicker" value="'.$userData.'"/>
						<span class="description">'.$item_desc.'</span>
					</td>
				</tr>
			</table>';
		
		$filterArray['datepickerCustomField'] = apply_filters('wppb_'.$page.'_datepicker_custom_field_'.$id, $filterArray['datepickerCustomField'], $userData, $item_title, $item_id, $id, $item_desc);		
	}else{
		...
		$filterArray['datepickerCustomField'] = '
			<p class="form-input'.$id.$errorVar.'">
				<label for="'.$item_title.'">'.$item_title.$errorMark.'</label>
				<input name="'.$item_type.$id.'" type="text" class="wppb_datepicker" value="'.$userData.'" />
				<span class="wppb-description-delimiter">'.$item_desc.'</span>					
			</p><!-- .form-input'.$id.' -->';
		$filterArray['datepickerCustomField'] = apply_filters('wppb_'.$page.'_datepicker_custom_field_'.$id, $filterArray['datepickerCustomField'], $userData, $item_title, $item_id, $id, $item_desc, $item_required, $errorMark, $errorVar);
...
function wppb_textarea_handler($page, $item_title, $id, $item_desc, $item_required, $item_id, $item_type, $currentUser, $filterArray, $extraFieldsErrorHolder, $postData, $item_options, $error, $fieldName){
	...
	if ($page == 'back_end'){
		...
		$filterArray['textareaCustomField'] = apply_filters('wppb_'.$page.'_textarea_custom_field_'.$id, $filterArray['textareaCustomField'], $inputValue, $item_title, $item_id, $id, $item_desc);		
	}else{
		$errorVar = '';
		$errorMark = '';
		if (isset($item_required))
		...
		$filterArray['textareaCustomField'] = apply_filters('wppb_'.$page.'_textarea_custom_field_'.$id, $filterArray['textareaCustomField'], $inputValue, $item_title, $item_id, $id, $item_desc, $item_required, $errorMark, $errorVar);		
	}
...
function wppb_agree_to_terms_handler($page, $item_title, $id, $item_desc, $item_required, $item_id, $item_type, $currentUser, $filterArray, $extraFieldsErrorHolder, $postData, $item_options, $error, $fieldName){
	...
	if ($page == 'register'){
		...
		$filterArray['agreeToTermsCustomField'] = '
			<p class="form-checkbox'.$id.$errorVar.'">
					<label for="'.$item_title.'">'.$item_title.$errorMark.'</label>';						
					$filterArray['agreeToTermsCustomField'] .= '<input value="agree" name="'.$item_type.$id.'" type="checkbox"'; 
		...
		$filterArray['agreeToTermsCustomField'] = apply_filters('wppb_'.$page.'_upload_custom_field_'.$id, $filterArray['agreeToTermsCustomField'], $item_title, $item_id, $id, $item_desc, $item_required, $errorMark, $errorVar);		
	}
