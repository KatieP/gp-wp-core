...
class PB_Admin{
  ...
  function profile_builder_activate(){
	...
	$wppb_default_settings = array(
		...
		$wppb_addon_settings_description = array( 'wppb_userListing' => 'User-Listing', 
												  'wppb_customRedirect' => 'Custom Redirects',
												  'wppb_reCaptcha' => 'reCAPTCHA');
		$wppb_addon_settings = array( 'wppb_userListing' => 'hide', 
		...
		if (file_exists($wppb_addons_file))
			update_option('wppb_addon_settings_description', $wppb_addon_settings_description); //update the array containing the addons' descriptions
